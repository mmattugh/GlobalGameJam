...
var j = 0;
for (var i = 0; i <= length-1; i += length/nodes) {
...
p2 = instance_create_depth(x+length*xstep,y+length*ystep,depth,oPhysicsChainLanternLink);
verlet_point_set_mass(p2, 3.0);
