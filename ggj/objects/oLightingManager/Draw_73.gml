...
shader_set(shd_lighting);
	...
	shader_set_uniform_f(lighting_uniform_noise_settings, lighting_noise_settings, round(current_time*0.001*noise_fps) mod (1000)); //vignette inner circle size, vignette outter circle size, noise strength, noise enable (1 or 0 only).
